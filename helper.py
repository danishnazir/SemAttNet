...
class logger:
    def __init__(self, args, prepare=True):
        self.args = args
        output_directory = "training_logs/" + get_folder_name(args)
...
def backup_source_code(backup_directory,directory):
    if os.path.exists(backup_directory):
        shutil.rmtree(backup_directory)
    print("Backup Directory",backup_directory)
    #shutil.copytree(Path().absolute(), directory + "/" + backup_directory, ignore=ignore_hidden)
